...
export default function ProductItem({ product, delay }: ProductItemProps) {
      ...
      <div className="product-item rounded wow fadeInUp" data-wow-delay={delay}>
        <div className="product-item-inner border rounded">
          <div className="product-item-inner-item">
            ...
            />
            {product.isNew && <div className="product-new">Mới</div>}
            {product.isSale && <div className="product-sale">Giảm giá</div>}
